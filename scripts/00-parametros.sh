...
# Data de atualização: 30/11/2022
# Versão: 0.1
# Testado e homologado para a versão do Debian 11
#
# Parâmetros (variáveis de ambiente) utilizados nos scripts de instalação dos Serviços de Rede
# no Debian 11, antes de modificar esse arquivo, veja os arquivos: BUGS, NEW e
...
NETPLAN="/etc/network/interfaces"
#
#=============================================================================================
...
DOMAINREV="255.31.172.in-addr.arpa"
#
...
GRAFANADEP="mysql-server mysql-common apt-transport-https software-properties-common"
#
...
ZABBIXIREP="wget https://repo.zabbix.com/zabbix/6.2/debian/pool/main/z/zabbix-release/zabbix-release_6.2-4%2Bdebian11_all.deb"
#
...
ZABBIXDEP="mysql-server mysql-common apache2 php apt-transport-https software-properties-common"
#
