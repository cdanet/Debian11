...
clear
if [ "$USUARIO" == "0" ] && [ "$DEBIAN" == "11" ]
	then
		echo -e "O usuário é Root, continuando com o script..."
		echo -e "Distribuição é >= 20.04.x, continuando com o script..."
		sleep 5
	else
		echo -e "Usuário não é Root ($USUARIO) ou a Distribuição não é >= 11 ($DEBIAN)"
...
echo
#
echo -e "Instalação do Zabbix Server e Agent no GNU/Linux Debian 11\n"
